...
/**
 * get_int - To gets a character pointer to new string containing int
...
/**
 * _abs - To gets the absolute value of an integer
...
/**
 * get_numbase_len - To gets length of buffer needed for an unsigned int
 * @num:The number to get length needed for
 * @base:The base of number representation used by buffer
 *
 * Return:The integer containing length of buffer needed (doesn't contain null bt)
 */
int get_numbase_len(unsigned int num, unsigned int base)
{
...
/**
 * fill_numbase_buff - To fills buffer with correct numbers up to base 36
